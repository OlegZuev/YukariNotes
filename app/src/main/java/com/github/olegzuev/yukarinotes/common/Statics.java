...
public class Statics {
    ...
    //  JP Ninon database
    public static final String DB_FILE_NAME_COMPRESSED_JP_NINON = "redive_jp_ninon.db.br";
    public static final String DB_FILE_NAME_JP_NINON = "redive_jp_ninon.db";
    public static final String LATEST_VERSION_URL_JP_NINON = API_URL + "/last_version_jp.json";
    public static final String BACKUP_LATEST_VERSION_URL_JP_NINON = "https://roboninon.win/db/version";
    public static final String DB_FILE_URL_JP_NINON = API_URL + "/db/" + DB_FILE_NAME_COMPRESSED_JP;
    public static final String BACKUP_DB_FILE_URL_JP_NINON = "https://roboninon.win/db/download";
    ...
    //  App URL
    public static final String APP_RAW = "https://raw.githubusercontent.com/OlegZuev/YukariNotes/master";
    public static final String APP_UPDATE_LOG = APP_RAW + "/update_log.json";
    public static final String APP_PACKAGE = "https://github.com/OlegZuev/YukariNotes/releases/latest/download/yukarinotes-release.apk";
    public static final String APK_NAME = "yukarinotes-release.apk";
}
